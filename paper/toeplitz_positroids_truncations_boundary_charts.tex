...
The root-of-unity Toeplitz point used below belongs to the Grassmannian part of Rietsch's description of total positivity and quantum cohomology \cite{RietschGrassmannian,Rietsch}.  Rietsch's recent ICM survey and work of Chung-Halpern and Rietsch place the same centered-root parametrization in its current Toeplitz, Grassmannian, and asymptotic context \cite{RietschSurvey,ChungHalpernRietsch}.  Toeplitz-minor identities in terms of skew Schur specializations were developed systematically by Garc\'ia-Garc\'ia and Tierz \cite{GarciaTierz}.  Interval positroids and their paving obstructions have been studied from a complementary matroid-theoretic viewpoint \cite{Knutson,Park}.
...
the \href{https://github.com/Cheng-Yaoyu/toeplitz-positroids-truncations-boundary-charts-formalization}{GitHub repository}.
...
\href{https://raw.githubusercontent.com/Cheng-Yaoyu/paving-toeplitz-positroids-formalization/main/paper/positive_consecutive_minor_interpolation_and_paving_toeplitz_positroids.pdf}{GitHub manuscript}.
