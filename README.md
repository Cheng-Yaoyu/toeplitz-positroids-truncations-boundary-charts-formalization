...
This repository is Paper C in the Toeplitz-positroid project. It reuses Paper B,
which in turn imports the checked matrix, Toeplitz, low-rank, and finite-Edrei
infrastructure from Paper A.
...
The proved results in Sections 2--7 are fully formalized, including the
